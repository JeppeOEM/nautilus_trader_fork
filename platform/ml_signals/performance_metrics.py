...
# -------------------------------------------------------------------------------------------------
"""
Deprecated re-export shim (Story 23.2): `ml_signals.performance_metrics` moved to the shared kernel (kernel.performance_metrics).
...
__all__ = ["all_metrics", "equity_returns", "return_stats", "trade_stats"]

REMOVE_AFTER = "24-2-views-read-models-and-reader-side-revalidation-removed"

# Attributed to the importing module, not to importlib's frames.
warnings.warn(
    "ml_signals.performance_metrics moved to kernel.performance_metrics (Story 23.2); "
