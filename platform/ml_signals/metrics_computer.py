...
def compute_snapshot(
    ...
    (platform/CLAUDE.md SSOT-02): that process must never run two independent stateful
...
def compute_all(
    ...
    what OOM-crashed ranking_engine repeatedly (see platform/CLAUDE.md DATA-02 incident,
