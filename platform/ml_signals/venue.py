...
# -------------------------------------------------------------------------------------------------
"""
Deprecated re-export shim (Story 23.2): `ml_signals.venue` moved to the shared kernel (kernel.venues).
...
__all__ = ["MalformedInstrumentId", "venue_of"]

REMOVE_AFTER = "24-2-views-read-models-and-reader-side-revalidation-removed"

# Attributed to the importing module, not to importlib's frames.
warnings.warn(
    "ml_signals.venue moved to kernel.venues (Story 23.2); "
