...
# -------------------------------------------------------------------------------------------------
"""
Deprecated re-export shim (Story 23.2): `collector_core.second_snapshot` moved to the shared kernel (kernel.second_snapshot).
...
__all__ = ["BOOK_DEPTH", "DydxSecondSnapshot"]

REMOVE_AFTER = "24-2-views-read-models-and-reader-side-revalidation-removed"

# Attributed to the importing module, not to importlib's frames.
warnings.warn(
    "collector_core.second_snapshot moved to kernel.second_snapshot (Story 23.2); "
