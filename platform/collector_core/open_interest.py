...
# -------------------------------------------------------------------------------------------------
"""
Deprecated re-export shim (Story 23.2): `collector_core.open_interest` moved to the shared kernel (kernel.open_interest).
...
__all__ = ["OpenInterest"]

REMOVE_AFTER = "24-2-views-read-models-and-reader-side-revalidation-removed"

# Attributed to the importing module, not to importlib's frames.
warnings.warn(
    "collector_core.open_interest moved to kernel.open_interest (Story 23.2); "
