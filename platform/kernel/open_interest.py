...
# -------------------------------------------------------------------------------------------------
"""
Open interest for one perpetual, shared by the dYdX, Bybit and Hyperliquid collectors (kernel,
DDD spine AD-D3).

Invariant: `OpenInterest` is registered for Arrow exactly once, under this class name (the
catalog directory `custom_open_interest` derives from `__name__`) and this schema.
