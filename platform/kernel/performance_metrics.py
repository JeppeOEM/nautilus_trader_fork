...
profit factor, expectancy, win rate, avg/max win/loss) -- kernel, DDD spine AD-D3.

Invariant: one implementation of each formula, pure arithmetic over the caller's data (no I/O,
no state), shared by live trading and research.
...
# Never configurable (platform/CLAUDE.md DESIGN-01): the venue's trading calendar doesn't
# change.
