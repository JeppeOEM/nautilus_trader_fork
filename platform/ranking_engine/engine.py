...
# id is in this set (platform/CLAUDE.md DATA-02: removes the recurring re-scan from the
...
_USER_AGENT: str = "nautilus-platform-ranking-engine/1.0"
...
def _legacy_book_metrics_for(iid: str) -> dict:
    ...
    reads for rankings:live -- platform/CLAUDE.md SSOT-02: this process must never run
...
async def _slow_loop_task(catalog_path: str) -> None:
    ...
    nifelheim's OOM-restart loop, platform/CLAUDE.md DATA-02 incident 2026-09-11) to
    ...
    Cycle-duration canary (platform/CLAUDE.md DATA-02: "a staleness/health canary on your
