...
- [ ] Task 4 — verification (no tests: TEST-02, docs only)
  - [ ] `grep -rn "dydx_collector.second_snapshot\|dydx_collector.minute_rollup\|dydx_collector.integrity\|DydxMinuteBar\|DydxOpenInterest" troll _bmad-output/planning-artifacts/architecture troll/CLAUDE.md CLAUDE.md` returns only historical/archive mentions (audit §1, story files).
