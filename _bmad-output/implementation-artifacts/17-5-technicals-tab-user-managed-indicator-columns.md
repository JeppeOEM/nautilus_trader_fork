...
Owed: visual browser check of Technicals headers/picker -- not performed; marked done anyway. AC5 gear icon on headers not implemented (params edited via picker) -- accepted drift.
