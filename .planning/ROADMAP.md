...
- [ ] **Phase 1: Bootstrap, Config & End-to-End Slice** - Config-driven node records trades for one instrument all the way into the day-partitioned catalog
...
|-------|----------------|--------|-----------|
| 1. Bootstrap, Config & End-to-End Slice | 0/TBD | Not started | - |
