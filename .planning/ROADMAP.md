...
- [x] 06-01-PLAN.md — Config-reload timer + diff engine + REMOVAL/PARAM-CHANGE branches + `max_hot_added_instruments` knob (D-01/D-02/D-03/D-05/D-06/D-08) + unit tests
...
- [x] 07-02-PLAN.md — dYdX recorder config: flat-perp TOML parser + bar-interval whitelist fail-fast + DydxNetwork mapping + relaxed-quote thresholds + config tests (DYDX-02, DYDX-05, DYDX-06)
...
- [ ] 07-04-PLAN.md — Live dYdX mainnet smoke: all 7 feeds land in shared catalog + clean SIGTERM flush (DYDX-03, DYDX-07)
