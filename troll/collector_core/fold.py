...
# -------------------------------------------------------------------------------------------------
"""
The one trades -> second fold (story 22.13, audit D-46): shared by the live `_sample_tick`, the
nightly `rebuild_seconds` and any strategy feature code, so the three can never disagree.
