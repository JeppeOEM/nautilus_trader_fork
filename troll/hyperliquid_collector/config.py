...
# -------------------------------------------------------------------------------------------------
"""Hyperliquid collector config: a plain TOML file, read once at startup (no live reload/control)."""
...
class CollectorConfig:
    ...
    instruments: tuple[str, ...]  # e.g. "BTC-USD-PERP.HYPERLIQUID"
...
def load_config(path: Path) -> CollectorConfig:
    ...
    return CollectorConfig(
        ...
        stale_book_seconds=float(raw.get("stale_book_seconds", 30.0)),
